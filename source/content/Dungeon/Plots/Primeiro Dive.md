...
**D&D 5e RAW** (PHB, DMG, MM). Nenhuma house rule do [[../Arena/Plots/Festival do Sangue|Festival do Sangue]] se aplica.

| Usar | Evitar |
|------|--------|
| PHB: combate, descanso, death saves, level-up | Regras extras de “só level-up em santuário” |
| DMG: milestone (p. 261) **ou** XP; encounter CR; treasure | Níveis dados por NPC mentor |
| MM: stat blocks oficiais | Rituais de res/level inventados |
| *Revivify*, *raise dead* com componentes PHB | Mecânicas únicas não publicadas |

**Santuário** (ficção): local onde o DM permite **descanso longo** (PHB p. 186). Não é mecânica nova.

**Sessão zero:** escolher **milestone (A)** ou **XP (B)** — uma opção apenas. Mesa: **7 jogadores**, níveis **5 → 8** em **10 sessões**.
...
Ver [[../Locais/Mapa Mestre do Complexo]].

O complexo funciona como uma **pirâmide invertida**: os andares mais fundos são maiores, mais selvagens e mais biológicos; quanto mais perto da superfície, menores, mais artificiais e mais conectados à guilda/prova. Cada andar pode ter um boss local, mas **nenhum boss é obrigatório** para subir. Bosses são oportunidades de recompensa, atalhos, alianças, vingança ou controle de território.

| Camada | Sessões | Tom |
|--------|---------|-----|
| [[../Locais/Antecamara da Guilda|Antecâmara]] | 1 | Seguro → Saída A selada |
| [[../Locais/Stratum Novato\|Stratum novato]] | 1–2 | Tranquilo |
| [[../Locais/Fenda do Tremor\|Ruptura]] | 3 | Choque |
| Andares inferiores PR-3→PR-1 | 4–7 | Brutal, desorientado |
| Rotas superiores / saída NU-* | 8–10 | Clímax + fuga |

### Regra de agência por andar

Cada andar deve oferecer:

- 1 rota óbvia para cima, perigosa.
- 1 rota alternativa, social, técnica ou secreta.
- 1 boss local opcional.
- 1 conflito ou consequência que muda o estado do andar.
- 1 pista sobre a guilda, o Predador ou a estrutura vertical.

Derrotar um boss nunca deve ser a única condição para avançar. Um boss pode guardar a rota mais segura, controlar recursos, ameaçar uma facção, carregar uma chave útil ou oferecer uma aliança, mas sempre deve existir outro caminho com custo diferente.

### Facções e conflitos

A partir dos andares médios, o complexo deixa de ser só ambiente hostil e passa a ter **facções de monstros em conflito**. Os PJs podem lutar, negociar, enganar, sabotar ou atravessar sem se envolver.

Tipos de conflito úteis:

- Território: duas facções disputam uma rota vertical.
- Recurso: comida, luz, cura, abrigo seguro ou ferramenta de subida.
- Relíquia: objeto da guilda/prova que abre portas ou atrai o Predador.
- Medo: uma facção paga passagem para evitar um boss.
- Mentira: uma facção culpa outra pelo Predador ou pelo tremor.

---

## Calendário das 10 sessões
...
| **8** | Desespero | Aproximação dos níveis de treino; rota bloqueada | SN profundo / NU-01 | 8 | Saída existe acima |
| **9** | Corrida | Abrir passagem para cima; Predador bloqueia (pré-boss) | NU-02 ou NU-03 | 8 | Porta/poço liberado |
| **10** | Clímax | **Boss = Predador S3**; subida final; epílogo | boca da saída | 8 | **Fim** |
...
- Tremor recomendado: **fim da sessão 2**.
- Sessão curta: comprimir setores, não criar S11.
- Capítulos futuros: `Primeiro Dive - Capítulo N - …` em [[../Sessoes/]].
...
## O Predador (antagonista único)

Detalhes: [[../NPCs/O Predador]]. **Mesma criatura** na S3 e boss S10.
...
### Milestone (recomendado — método A)
...
Usar DMG encounter building + treasure tables; calibrar para limiares equivalentes a 5→8 em 10 sessões.

### Descanso longo

- Antecâmara / SN: OK em S1–2.
- PR-1-04, salas seguras: adjudicação PHB.
- Predador não deve bloquear **todo** long rest sem alternativa.

---

## Morte de personagens (§9)
...
## Mesa com 7 jogadores (§11)

- DMG *Creating Encounters*: budget **×1.5–1.75** (ou mais criaturas).
- S1–2: ainda fáceis; mais alvos para todos jogarem.
- *Revivify*: um morto por cast; escassez de componentes = ficção.

---

## Referência rápida 5e
...
## Próximos desenvolvimentos (pós-fundação)

- Escolher stat block canônico do Predador (ver NPC).
- Preencher fichas em [[../Players/]].
- Roteiros por sessão em [[../Sessoes/]].
- Mapa visual em [[../Mapas/]].
