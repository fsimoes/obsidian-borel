...
Queda para o fundo seco/mineral:

![[../Mapas/Concepts/andar-10-deserto-obsidiana.png]]

Mapa da cena do portal:

![[../Mapas/Battlemaps/fenda-portal-sala-treinamento-roll20.png]]

Momento da morte do avaliador:

![[../NPCs/Concepts/predador-mata-instrutor.png]]

## Características sensoriais

- Ar mais quente, seco e carregado de poeira que o stratum.
- Marcas de garras **frescas** sobre arranhões antigos.
- Som distante — para quando o grupo para de falar.
- Luz das tochas não penetra mais que alguns metros na fenda.
- O portal pulsa em silêncio, mas puxa poeira, cinza e pequenas pedras para dentro.
- A cada PJ que atravessa, o portal fica mais transparente: primeiro perde o brilho nas bordas, depois mostra a pedra atrás dele, até parecer uma película quase invisível.

## Sessão 3 — cena âncora
...
- Imediato: Predador (introdução).
- Ataques durante a travessia: o Predador não espera a decisão terminar; ele pressiona os retardatários, mira quem tenta proteger a retaguarda e força escolhas rápidas de ordem, sacrifício e ajuda.
