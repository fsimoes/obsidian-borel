...
- [x] `style.md` v2
- [x] Regenerar arte (`images-pending-regen`) — 2026-06-18 tick 461257 #4

## Revisão texto+refs (2026-06-18 — tick 461257 #4)

- `dialogues.md` OK. Fonte: `script` + `dialogues`.
- Refs: 13 PNGs (estilo + PCs + Rita revolta + guardas cristal + Elriste).

## Publicação v2 (2026-06-18 — tick 461257 #4)

- 18 PNG v2 gerados (`cap12-001`…`018`), copiados para `pages/` e `quartz/static/comic/cap-12-sessao-12/`.
