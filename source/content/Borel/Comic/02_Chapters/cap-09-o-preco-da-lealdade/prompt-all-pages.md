---
title: "Prompt All Pages - Cap. 9"
status: docs-ready
---

# Prompt All Pages - Cap. 9 (v2)
...
--- PAGE 001 ---
Layout: 3 panel(s). navio no lago, barris de polvora, barcos pequenos prometidos por Rita.
Panel A — CHARACTERS & POSES: Rita (standing, weight on one foot, readable silhouette, focused, readable emotion).
Bubbles: see dialogues.md (D001.).
