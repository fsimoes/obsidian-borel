...
- Fidelidade Transcricoes/: falas extraídas
- Target pages: 17
...
| Métrica | Valor |
|---------|-------|
| Falas em `dialogues.md` | 80 |
| `canon` | 80 |
| `condensed` | 0 |
| `inferred` | 0 |
| Outros / sem tag | 0 |
| Arquivos `Transcricoes/` | sessao 23_bloco01.txt, sessao 23_bloco02.txt, sessao 23_bloco03.txt, sessao 23_bloco04.txt |
