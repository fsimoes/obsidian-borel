---
title: Snippet — Style Bible v2 (humor webcomic)
type: comic
tags:
  - rpg/borel
  - tipo/comic
...
# Style Bible v2 — snippet copiável

Usar em **todos os capítulos** (0–15). Ver seção completa em [[../00_Style_Bible#Style Bible v2 — Borel Funny Webcomic (padrão global jun/2026)|00_Style_Bible.md]].

## Prefixo (início de cada mensagem ChatGPT)
...
## Refs de estilo (anexar sempre, nesta ordem)
...
```text
Panel A — CHARACTERS & POSES: [Nome] ([pose], [expression], [hands/gaze]); ...
Bubbles: "..." ...
```
